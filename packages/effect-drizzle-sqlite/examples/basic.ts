...
class Database extends Context.Service<Database, DatabaseShape>()("@neuraldeepcode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@neuraldeepcode/example/UserStore") {
