...
Practical reference for the current tool-migration state in `packages/ndcode`.
...
Tool tests should use the existing Effect helpers in `packages/ndcode/test/lib/effect.ts`:
