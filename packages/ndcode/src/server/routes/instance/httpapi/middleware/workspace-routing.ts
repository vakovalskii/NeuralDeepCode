...
>()("@neuraldeepcode/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@neuraldeepcode/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.NDC_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.NDC_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-ndcode-directory"] || process.cwd()
}
