...
export const RootHttpApi = HttpApi.make("ndcode-root")
...
export const InstanceHttpApi = HttpApi.make("ndcode-instance")
...
export const NeuralDeepCodeHttpApi = HttpApi.make("ndcode")
