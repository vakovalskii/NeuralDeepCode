...
import { AccountStateTable, AccountTable } from "@neuraldeepcode/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@neuraldeepcode/AccountRepo") {}
