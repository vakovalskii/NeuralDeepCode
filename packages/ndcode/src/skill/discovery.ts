...
import { httpClient, path } from "@neuraldeepcode/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@neuraldeepcode/SkillDiscovery") {}
