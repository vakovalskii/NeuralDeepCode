...
import { ProjectDirectoryTable, ProjectTable } from "@neuraldeepcode/core/project/sql"
...
import { which } from "@neuraldeepcode/core/util/which"
...
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@neuraldeepcode/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@neuraldeepcode/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.NDC_FAKE_VCS)
