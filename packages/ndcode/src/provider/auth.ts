...
import type { AuthOAuthResult, Hooks } from "@neuraldeepcode/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@neuraldeepcode/ProviderAuth") {}
