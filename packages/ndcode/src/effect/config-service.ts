 ...
 *   "@neuraldeepcode/ServerAuthConfig",
 *   {
 *     password: Config.string("NDC_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("NDC_SERVER_USERNAME").pipe(Config.withDefault("ndcode")),
 *   },
 * ) {}
 *
