...
export function buildAuthorizeUrl(
  ...
  // clients. `referrer=ndcode` lets xAI attribute ndcode-originated
...
<html>
  <head>
    <title>NeuralDeepCode - xAI Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>NeuralDeepCode - xAI Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
async function startOAuthServer(): Promise<{ port: number; redirectUri: string }> {
  ...
  await new Promise<void>((resolve, reject) => {
    ...
    server.listen(OAUTH_PORT, OAUTH_HOST, () => {
      ...
      // behavior and crash the entire ndcode process. Matches the silent-
