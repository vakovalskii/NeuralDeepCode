...
import type { Model } from "@neuraldeepcode/sdk/v2"
...
<html>
  <head>
    <meta charset="utf-8" />
    <title>NeuralDeepCode - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to NeuralDeepCode."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. NeuralDeepCode will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
