...
<html>
  <head>
    <title>NeuralDeepCode - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>NeuralDeepCode - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput, options: CodexAuthPluginOptions = {}): Promise<Hooks> {
  ...
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "ndcode"
      output.headers["User-Agent"] = `ndcode/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
