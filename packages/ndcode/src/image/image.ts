...
export class Service extends Context.Service<Service, Interface>()("@neuraldeepcode/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __NDC_PHOTON_WASM_PATH?: string }).__NDC_PHOTON_WASM_PATH =
