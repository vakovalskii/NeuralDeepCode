...
import { PermissionV1 } from "@neuraldeepcode/core/v1/permission"
import { Slug } from "@neuraldeepcode/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@neuraldeepcode/llm"
...
import { PartTable, SessionTable } from "@neuraldeepcode/core/session/sql"
...
import { NonNegativeInt, optionalOmitUndefined } from "@neuraldeepcode/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".ndcode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@neuraldeepcode/Session") {}
