import type { JsonSchema, LLMRequest, ProviderMetadata } from "@neuraldeepcode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@neuraldeepcode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @neuraldeepcode/llm request objects from ndcode's session/AI SDK-shaped data.
  return LLM.request({
