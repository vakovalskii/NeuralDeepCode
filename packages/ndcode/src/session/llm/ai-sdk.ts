import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@neuraldeepcode/llm"
...
// Move this extraction into @neuraldeepcode/llm when Copilot is handled by the native runtime.
