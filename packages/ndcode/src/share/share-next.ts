...
import type * as SDK from "@neuraldeepcode/sdk/v2"
...
import { SessionShareTable } from "@neuraldeepcode/core/share/sql"
...
const disabled = process.env["NDC_DISABLE_SHARE"] === "true" || process.env["NDC_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@neuraldeepcode/ShareNext") {}
