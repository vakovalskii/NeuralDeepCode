...
import type { AssistantMessage as NeuralDeepCodeAssistantMessage, Message } from "@neuraldeepcode/sdk/v2"
...
export type AssistantTokenCost = Pick<NeuralDeepCodeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<NeuralDeepCodeAssistantMessage, "role"> &
  Partial<Pick<NeuralDeepCodeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@neuraldeepcode/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@neuraldeepcode/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@neuraldeepcode/ACPUsage") {}
