...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@neuraldeepcode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@neuraldeepcode/ACPDirectory") {}
