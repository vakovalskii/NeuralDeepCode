...
import { EventSequenceTable, EventTable } from "@neuraldeepcode/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@neuraldeepcode/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        NDC_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        NDC_WORKSPACE_ID: config.id,
        NDC_EXPERIMENTAL_WORKSPACES: "true",
