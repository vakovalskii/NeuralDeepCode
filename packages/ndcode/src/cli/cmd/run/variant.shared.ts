...
//
// The saved variant persists across sessions in ~/.local/state/ndcode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@neuraldeepcode/RunVariant") {}
