...
import { normalizePromptContent } from "@neuraldeepcode/tui/editor"
...
import { NDC_BASE_MODE, useBindings } from "@neuraldeepcode/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close NeuralDeepCode" } satisfies SlashOption,
    ]
