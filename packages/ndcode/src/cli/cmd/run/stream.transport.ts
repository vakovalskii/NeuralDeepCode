...
import type { Event, GlobalEvent, NeuralDeepCodeClient } from "@neuraldeepcode/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@neuraldeepcode/RunStreamTransport") {}
