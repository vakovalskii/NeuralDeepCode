...
import { openEditor } from "@neuraldeepcode/tui/editor"
import { registerNeuralDeepCodeKeymap } from "@neuraldeepcode/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerNeuralDeepCodeKeymap(keymap, renderer, input.tuiConfig)
