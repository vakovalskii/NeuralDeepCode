...
import type { NeuralDeepCodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@neuraldeepcode/sdk/v2"
import type { TuiConfig } from "@neuraldeepcode/tui/config"
...
type PromptModel = Parameters<NeuralDeepCodeClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<NeuralDeepCodeClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<NeuralDeepCodeClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<NeuralDeepCodeClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<NeuralDeepCodeClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<NeuralDeepCodeClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<NeuralDeepCodeClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<NeuralDeepCodeClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<NeuralDeepCodeClient["question"]["reject"]>[0]
