...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders NDC_CALLER", () => {
    process.env["NDC_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode NDC_CALLER", () => {
    process.env["NDC_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown NDC_CALLER", () => {
    process.env["NDC_CALLER"] = "unknown"
