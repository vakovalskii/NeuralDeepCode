...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips ndcode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-ndcode-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-ndcode-directory")).toBeNull()
      expect(result.get("x-ndcode-workspace")).toBeNull()
