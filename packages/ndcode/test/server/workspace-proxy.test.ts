...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips ndcode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-ndcode-directory"]).toBeUndefined()
      expect(forwarded["x-ndcode-workspace"]).toBeUndefined()
