...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/ndcode.git")).toEqual({ owner: "sst", repo: "ndcode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/ndcode")).toEqual({ owner: "sst", repo: "ndcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/ndcode.git")).toEqual({ owner: "sst", repo: "ndcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/ndcode")).toEqual({ owner: "sst", repo: "ndcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/ndcode.git")).toEqual({ owner: "sst", repo: "ndcode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/ndcode")).toEqual({ owner: "sst", repo: "ndcode" })
})
