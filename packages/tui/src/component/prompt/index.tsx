...
import type { AssistantMessage, FilePart, UserMessage } from "@neuraldeepcode/sdk/v2"
...
import { NDC_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useNeuralDeepCodeKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.NDC_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
