...
import defaultSoundPath from "@neuraldeepcode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@neuraldeepcode/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@neuraldeepcode/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@neuraldeepcode/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@neuraldeepcode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@neuraldeepcode/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "ndcode"
const DEFAULT_PACK_ID = "ndcode.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "NeuralDeepCode Default",
  builtin: true,
  sounds: {
