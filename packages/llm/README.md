...
Schema-first LLM core for ndcode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@neuraldeepcode/llm"
import { OpenAI } from "@neuraldeepcode/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@neuraldeepcode/llm/providers"
