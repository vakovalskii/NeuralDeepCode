...
export const TypeId: TypeId = "~@neuraldeepcode/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@neuraldeepcode/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@neuraldeepcode/effect-sqlite-node/NodeSqliteClient")
