...
>()("@neuraldeepcode/HttpApiLocation") {}
...
function ref(request: HttpServerRequest.HttpServerRequest): Location.Ref {
  ...
  const workspaceID = query.get("location[workspace]") || request.headers["x-ndcode-workspace"]
  const directory =
    query.get("location[directory]") ||
    (request.headers["x-ndcode-directory"] ? decode(request.headers["x-ndcode-directory"]) : process.cwd())
