...
import { ProviderPlugins } from "@neuraldeepcode/core/plugin/provider"
import { ZenmuxPlugin } from "@neuraldeepcode/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://neuraldeep.ru/", "X-Title": "ndcode" })
