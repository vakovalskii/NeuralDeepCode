import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@neuraldeepcode/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
