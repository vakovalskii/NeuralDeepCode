...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@neuraldeepcode/llm"
...
export class Service extends Context.Service<Service, Interface>()("@neuraldeepcode/v2/ToolRegistry") {}
