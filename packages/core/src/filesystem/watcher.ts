...
declare const NDC_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof NDC_LIBC === "undefined" ? undefined : NDC_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@neuraldeepcode/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.NDC_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.NDC_EXPERIMENTAL_FILEWATCHER) {
