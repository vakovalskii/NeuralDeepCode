...
export class Service extends Context.Service<Service, Interface>()("@neuraldeepcode/v2/FileSystem/Search") {}
...
export const defaultLayer = Layer.unwrap(
  Effect.sync(() => (Flag.NDC_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)),
)
