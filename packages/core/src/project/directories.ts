...
import type { EffectDrizzleSqlite } from "@neuraldeepcode/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@neuraldeepcode/ProjectDirectories") {}
