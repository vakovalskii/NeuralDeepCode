export * as NeuralDeepCode from "./ndcode"
...
/** Intentional public native API for Effect applications embedding NeuralDeepCode. */
export class Service extends Context.Service<Service, Interface>()("@neuraldeepcode/public/NeuralDeepCode") {}
...
>()("@neuraldeepcode/public/NeuralDeepCode/SessionModelValidation") {}
...
const SessionModelValidationLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return SessionModelValidation.of({
      validate: Effect.fn("NeuralDeepCode.sessions.validateModel")(function* (input) {
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      ...
      sessions: {
        ...
        get: sessions.get,
        list: sessions.list,
        switchModel: Effect.fn("NeuralDeepCode.sessions.switchModel")(function* (input) {
...
// TODO: Add NeuralDeepCode.create(...) as the Promise facade over the same native API semantics.
