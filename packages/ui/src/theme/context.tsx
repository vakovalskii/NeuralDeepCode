...
const STORAGE_KEYS = {
  THEME_ID: "ndcode-theme-id",
  COLOR_SCHEME: "ndcode-color-scheme",
  THEME_CSS_LIGHT: "ndcode-theme-css-light",
  THEME_CSS_DARK: "ndcode-theme-css-dark",
} as const
