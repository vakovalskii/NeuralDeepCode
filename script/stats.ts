...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/ndcode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/ndcode...\n")
...
console.log("Fetching npm all-time downloads for ndcode-ai...\n")
const npmDownloads = await fetchNpmDownloads("ndcode-ai")
