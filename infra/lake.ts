...
const tableBucketName = `ndcode-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `ndcode-${$app.stage}-lake-ingest`,
    destination: "iceberg",
