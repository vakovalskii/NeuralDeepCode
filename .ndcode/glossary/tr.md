...
- PR #15835: https://github.com/anomalyco/ndcode/pull/15835

## Do Not Translate (Locale Additions)

- `NeuralDeepCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `ndcode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `NeuralDeepCode` in prose, `ndcode` only for exact technical identifiers
...
- Avoid changing `ndcode` to `NeuralDeepCode` inside commands, URLs, package names, or code literals
