...
- PR #13942: https://github.com/anomalyco/ndcode/pull/13942

## Do Not Translate (Locale Additions)

- `NeuralDeepCode` (preserve casing in prose; keep `ndcode` only when it is part of commands, package names, paths, or code)
- `NeuralDeepCode Zen`
- `NeuralDeepCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `ndcode` in prose when referring to the product name; use `NeuralDeepCode`
