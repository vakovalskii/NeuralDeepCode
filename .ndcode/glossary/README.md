...
Use this folder for locale-specific translation guidance that supplements `.ndcode/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/ndcode/pull/12345

## Do Not Translate (Locale Additions)

- `NeuralDeepCode` (preserve casing)
