...
- PR #10809: https://github.com/anomalyco/ndcode/pull/10809
- PR #11496: https://github.com/anomalyco/ndcode/pull/11496

## Do Not Translate (Locale Additions)

- `NeuralDeepCode` (preserve casing in prose; keep `ndcode` only in commands, package names, paths, or code)
- `NeuralDeepCode CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
