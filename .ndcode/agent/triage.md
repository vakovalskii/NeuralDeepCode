...
Desktop application and browser-based app issues, including `ndcode web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core ndcode server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

NeuralDeepCode Zen, NeuralDeepCode Go, and billing issues.
